...
export function FestiveBanner() {
  return (
    <section className="py-24 bg-gradient-to-br from-[#3d1259] via-primary to-[#5d2380] relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-20 w-80 h-80 bg-[#f4d56f]/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <h2 
              className="text-5xl md:text-7xl text-[#fdfbf7] mb-6 leading-tight font-bold"
          ...
          <div className="relative group">
            <div className="relative rounded-3xl overflow-hidden shadow-[0_0_60px_rgba(212,175,55,0.4)] border-4 border-[#d4af37] group-hover:shadow-[0_0_80px_rgba(212,175,55,0.6)] transition-all duration-700">
              <img
                src="https://images.unsplash.com/photo-1756483510767-35245638c057?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbmRpYW4lMjB0cmFkaXRpb25hbCUyMGRyZXNzJTIwZWxlZ2FudHxlbnwxfHx8fDE3NzM5MDgwNDR8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
