...
export function HeroSection({ slides }) {
  const settings = {
    ...
    autoplaySpeed: 8000,
    fade: true,
    nextArrow: <NextArrow customClass="!absolute !right-6 md:!right-12 !top-1/2 !-translate-y-1/2 !z-30" />,
    prevArrow: <PrevArrow customClass="!absolute !left-6 md:!left-12 !top-1/2 !-translate-y-1/2 !z-30" />,
