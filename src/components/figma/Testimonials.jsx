...
export function Testimonials() {
  ...
  useEffect(() => {
    try {
      const allReviewsStr = localStorage.getItem('product_reviews');
      if (allReviewsStr) {
      ...
      console.error("Failed to parse reviews for testimonials", e);
    }
  }, []);
    ...
    <section className="py-20 bg-primary relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          <span className="text-[#d4af37] tracking-widest mb-2 block">
            TESTIMONIALS
          </span>
          <h2 
            className="text-4xl md:text-5xl text-[#fdfbf7]"
