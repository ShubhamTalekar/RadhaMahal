...
export function NextArrow({ onClick, customClass, iconSize = 6 }) {
    return (
        <button 
            type="button"
            onClick={onClick} 
            className={`${customClass} hidden md:flex items-center justify-center w-12 h-12 md:w-16 md:h-16 !bg-[#d4af37] rounded-full text-[#4b284d] transition-all duration-300 hover:scale-105 hover:brightness-105 active:scale-95 group z-30`}
