...
export function FeaturedCategories({ categories = [] }) {
    ...
    return (
        <section
            id="collections"
            className="py-24 bg-gradient-to-b from-[#fdfbf7] via-[#f5f1ed] to-[#fdfbf7] relative overflow-hidden"
        >
            {/* Decorative elements */}
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center mb-20">
                    <div className="flex items-center justify-center gap-3 mb-6">
                        ...
                        <span className="text-[#d4af37] tracking-[0.3em] font-bold text-sm">COLLECTIONS</span>
                        <Sparkles className="w-7 h-7 text-[#d4af37] animate-pulse" />
                    </div>
                    <h2 className="text-5xl md:text-7xl text-primary mb-6 font-bold">
                        Explore Our{' '}
                            ...
                            >
                                <div className="aspect-[16/9] overflow-hidden">
                                    <img
                                        src={category.image}
                                        alt={category.name}
                                        className="w-full h-full object-cover object-center scale-[0.99] transition-transform duration-1000 group-hover:scale-[1.55]"
                                    />
                                </div>
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-8 text-center">
                                    <h3 className="text-4xl text-[#fdfbf7] mb-3 transform translate-y-0 group-hover:-translate-y-3 transition-transform duration-500 font-bold drop-shadow-lg">
                                        {category.name}
                                    </h3>
                                    <p className="text-lg text-[#d4af37] opacity-0 group-hover:opacity-100 transform translate-y-6 group-hover:translate-y-0 transition-all duration-500 font-semibold">
